...
abstract class AppLocalizations {
  ...
  /// Error message when spots fail to load
  ///
  /// In en, this message translates to:
  /// **'Error loading spots: {error}'**
  String errorLoadingSpots(String error);

  /// Title for empty state overlay
  ///
  /// In en, this message translates to:
  /// **'No spots here!'**
  String get noSpotsHereTitle;

  /// Description for empty state overlay
  ///
  /// In en, this message translates to:
  /// **'Try adjusting your filters or\nexplore a different area.'**
  String get noSpotsHereDescription;

  /// Error message when no spots match the selected mode
  ///
  /// In en, this message translates to:
  /// **'No spots match \'{mode}\' — try \'Surprise Me\'!'**
  String noSpotsMatchMode(String mode);

  /// Generic error message for spin failure
  ///
  /// In en, this message translates to:
  /// **'Something went wrong. Try spinning again.'**
  String get genericSpinError;
  ...
  /// Button label to enable a setting
  ///
  /// In en, this message translates to:
  /// **'Enable'**
  String get enable;
  ...
  /// Message when map tiles fail to load
  ///
  /// In en, this message translates to:
